...
const menuSetup = {
  ...
  permanent: [12, 58, 25, 1, 2, 21, 0, 11, 3, 8, 37, 4, 6, 7, 9, 18, 44, 13, 17],
};
...
export const trimmed = JSON.stringify(
  supportedPools.map((pool) => {
    return { pid: pool.pid, name: pool.name, symbol: pool.symbol, icon: pool.icon };
  })
);

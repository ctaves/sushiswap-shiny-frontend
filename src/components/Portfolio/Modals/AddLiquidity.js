...
import ClassicAdd from "../../../services/exchange/pages/AddLiquidity/secondary";

const AddLiquidity = ({ onDismiss, data }) => {
  return (
    <>
      ...
      >
        ...
        <div className="items-start">
          <div className="text-left">
            ...
            <div>
              <ClassicAdd currencyIdA={data?.token0} currencyIdB={data?.token1} />
            </div>
          </div>
        </div>
      </div>

...
import Row, { RowFixed } from "../../services/vision/components/Row";
import TokenLogo from "../../components/TokenLogo";
import DoubleTokenLogo from "../../components/DoubleLogo";
import { Search as SearchIcon, X } from "react-feather";
import { BasicLink } from "../../components/Link";

import { useAllTokenData, useTokenData } from "../../services/vision/contexts/TokenData";
import { useAllPairData, usePairData } from "../../services/vision/contexts/PairData";
import { useAllPairsInUniswap, useAllTokensInUniswap } from "../../services/vision/contexts/GlobalData";
import { OVERVIEW_TOKEN_BLACKLIST, PAIR_BLACKLIST } from "../../services/vision/constants";

import { client } from "../../apollo/client";
import { PAIR_SEARCH, TOKEN_SEARCH } from "../../apollo/queries";

import { TYPE } from "../../services/vision/Theme";
import FormattedName from "../../components/FormattedName";
import { transparentize } from "polished";
import { useMedia } from "react-use";

import { useTokens, usePairs } from "../../shared/contexts/GlobalData";
...
const Wrapper = styled.div`
  ...
  border-bottom: ${({ open }) => (open ? "0px" : "1px solid #d2d6dc")};
  border-radius: 5px;
...
export const Search = ({ small = false }) => {
  let allTokens = useTokens(); //useAllTokensInUniswap();
  const allTokenData = useTokens(); //useAllTokenData();
  let allPairs = usePairs(); //useAllPairsInUniswap();
  const allPairData = usePairs(); //useAllPairData();

  //console.log("search:", allTokenData, allPairData);

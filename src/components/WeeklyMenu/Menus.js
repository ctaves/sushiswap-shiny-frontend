    ...
    <>
      <div className="sushi-p-6">
        ...
        <p className="sushi-mt-4 sushi-text-sm sushi-leading-5 sushi-text-gray-500">
          Current Onsen menu, harvest bonus rewards while they last! Regular fees generated by providing liqudity still
          apply.
        </p>
      ...
      <div className="sushi-relative sushi-w-4/5 md:sushi-w-1/3 sushi-mx-auto sushi-pl-6">
        ...
        >
          <div className="sushi-p-6">
            ...
            <p className="sushi-mt-4 sushi-text-sm sushi-leading-5 sushi-text-gray-500">
              Special onsen menus, harvest bonus rewards while they last! Regular fees generated by providing liqudity
              still apply.
            </p>
      ...
      <div className="sushi-relative sushi-w-4/5 md:sushi-w-1/3 sushi-mx-auto sushi-pl-6">
        ...
        >
          <div className="sushi-p-6">
            ...
            <p className="sushi-mt-4 sushi-text-sm sushi-leading-5 sushi-text-gray-500">
              Previous farms from Menu of the Week. Unstake and harvest your rewards any time you'd like.
            </p>
            <p className="sushi-mt-8">
              <span className="sushi-text-2xl sushi-leading-10 sushi-font-extrabold sushi-text-gray-900">
                Harvest SUSHI

          ...
          <div className="sushi-pt-10 sushi-pb-12 sushi-px-6 sm:sushi-pt-16 sm:sushi-px-16 lg:sushi-py-16 lg:sushi-pr-0 xl:sushi-py-20 xl:sushi-px-20">
            <div className="lg:sushi-self-center">
              <h2 className="sushi-text-3xl sushi-leading-9 sushi-font-extrabold sushi-text-gray-900 sm:sushi-text-3xl sm:sushi-leading-10">
                <span className="sushi-block">
                  <span role="img">👑</span> いただきます!
                </span>
              ...
              <button
                ...
                className="sushi-mt-8 sushi-bg-white sushi-border sushi-border-2 border-gray-900 sushi-rounded-md sushi-shadow sushi-px-6 sushi-py-3 sushi-inline-flex sushi-items-center sushi-text-base sushi-leading-6 sushi-font-medium text-gray-800 hover:text-gray-900 hover:bg-gray-50 sushi-transition sushi-duration-150 sushi-ease-in-out"
              >

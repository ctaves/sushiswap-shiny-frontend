      ...
      <div className="px-2 py-4">
        <div>
          <div className="flex-auto flex items-center justify-between">
            <div className="group w-full md:w-3/5 leading-6 flex items-center">
                ...
                <div>
                  <span className="rounded-md shadow-sm">
                    <button
                      ...
                      className="-ml-px relative flex items-center px-3 py-2.5 rounded-r-md border border-gray-300 text-sm leading-5 bg-white text-gray-900 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 transition ease-in-out duration-150"
                    >
                      {/* Filter Icon */}
